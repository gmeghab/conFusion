...
var app=angular.module('CyberDefenseConcentrationApp', []).controller('MenuController', ['$scope', function ($scope) {
   $scope.tab=1;
    $scope.filtText='';
    ...
    var courses=[
                        ...
                        },
        {
                        ...
                        {
                           name:'CITC 2344',
                           image: 'images/oracle_tn.jpg',
                           category: 'Elective',
                           label:'Database SQL Programming',
